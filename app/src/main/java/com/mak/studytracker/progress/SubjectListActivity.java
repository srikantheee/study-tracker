package com.mak.studytracker.progress;
...
import com.mak.studytracker.progress.dummy.DummyContent;
...
public class SubjectListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.subject_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(SubjectDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(SubjectDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(SubjectListActivity parent,
